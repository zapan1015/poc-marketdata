...
| 지표 | 목표 기준 | 초기 실측치 (MinBytes=10KB) | 튜닝 후 실측치 (MinBytes=1) | 판정 |
|---|---|---|---|:---:|
| **달성 TPS** | 10,000 | 9,999.6 TPS | 9,999.2 TPS | **PASS** |
| **p50 지연** | < 2.0 ms | 30.895 ms | **13.679 ms** (안정 구간 13.18 ms) | 55% 개선 |
| **p90 지연** | - | 62.591 ms | **19.263 ms** (안정 구간 18.78 ms) | 69% 개선 |
| **p95 지연** | < 5.0 ms | 71.487 ms | **20.719 ms** (안정 구간 20.00 ms) | 71% 개선 |
| **p99 지연** | < 10.0 ms | 85.823 ms | **21.92 ~ 78.27 ms** | 개선 확인 |
| **메모리 총합** | < 10 GB | ~1.23 GB | **~1.25 GB** | **PASS** |
